...
const fr: Dictionary = {
  ...
  gallery: {
    ...
    images: [
      ...
      { src: "/images/gallery/longere.jpg", alt: "La longère depuis le jardin" },
      { src: "/images/gallery/jardin-1.jpg", alt: "Le jardin et la terrasse" },
      { src: "/images/gallery/cote-jardin.jpg", alt: "La maison côté jardin" },
      { src: "/images/gallery/jardin-2.jpg", alt: "La maison et les herbes de la pampa" },
    ],
  },
