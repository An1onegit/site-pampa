...
const en: Dictionary = {
  ...
  gallery: {
    ...
    images: [
      ...
      { src: "/images/gallery/longere.jpg", alt: "The longère seen from the garden" },
      { src: "/images/gallery/jardin-1.jpg", alt: "The garden and terrace" },
      { src: "/images/gallery/cote-jardin.jpg", alt: "The garden side of the house" },
      { src: "/images/gallery/jardin-2.jpg", alt: "The house and the pampas grass" },
    ],
  },
